# HELIX strand — `spacex-ground-network`
...
|------|--------|------|------|
| `spacex_ground` | **alpha** | Ground link domain | Ground network truth — mesh connectivity + mission fusion |

### How this accelerates its twin

- **spacex_ground:** emits domain truth envelopes consumed by Omega/bridge pistons.
